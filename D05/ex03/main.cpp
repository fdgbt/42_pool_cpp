...
int				main(void)
{
	...
	Form	*robotomyRequest = NULL;
	Form	*presidentialPardon = NULL;
	Form	*shrubberyCreation = NULL;

	robotomyRequest = randomIntern.makeForm("", "Jean");
	std::cout << robotomyRequest << std::endl;

	robotomyRequest = randomIntern.makeForm("Robotomy_Request", "Jean");
	std::cout << robotomyRequest << std::endl;

	robotomyRequest = randomIntern.makeForm("Robotomy Request", "Jean");
	std::cout << robotomyRequest->getName() << std::endl;
	
	presidentialPardon = randomIntern.makeForm("Presidential PARDON", "Jacques");
	std::cout << presidentialPardon->getName() << std::endl;

	shrubberyCreation = randomIntern.makeForm("SHruBbErY cReAtIoN", "Paul");
