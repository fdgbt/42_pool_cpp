...
/*   Updated: 2021/05/06 19:01:15 by fdagbert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << target << " rigole." << std::endl;
...
{
	std::cout << target << " se contracte de douleurs." << std::endl;
...
{
	std::cout << target << " tombe à la renverse." << std::endl;
...
{
	std::cout << target << " est dans le mal." << std::endl;
...
{
	std::cout << target << " a perdu connaissance." << std::endl;
